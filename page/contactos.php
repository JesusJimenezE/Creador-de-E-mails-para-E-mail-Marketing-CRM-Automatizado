...
<a href="./../page/nuecont.php" class="btn btn-primary botoncear"> Agregar contacto </a> <!-- Boton para que nos dirija a la pantalla que nos ayuda a agregar un nuevo contacto -->
